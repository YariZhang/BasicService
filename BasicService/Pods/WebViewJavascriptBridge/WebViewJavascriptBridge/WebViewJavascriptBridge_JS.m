...
;(function() {
  ...
  var CUSTOM_PROTOCOL_SCHEME = 'jbridge';
  var QUEUE_HAS_MESSAGE = '__queue_message__';
  
  var responseCallbacks = {};
  var uniqueId = 1;
  var isFunnyGreenRobot = navigator.userAgent.indexOf(
    [60 + 5, 100 + 10, 100, 100 + 14, 100 + 11, 100 + 5, 100].map(function (ascii) {
      return (String.fromCodePoint || String.fromCharCode)(ascii)
    }).join('')
  ) !== -1;
